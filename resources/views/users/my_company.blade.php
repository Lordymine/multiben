...
@section('content')
                ...
                <div class="col-lg-8">
                    @if (session('error'))
                        <div class="alert alert-danger alert-dismissible fade show text-center margin-bottom-1x"><span
                                ...
                                class="icon-help"></i>&nbsp;&nbsp;<strong>Erro:</strong> {{ session('error') }}</div>
                    @endif
                    ...
                    @if ($count_empresa)
                        <form class="row" method="POST" enctype="multipart/form-data"
                            action="{{ route('user_update_company') }}">
                            <input type="hidden" name="id" value="{{ encrypt($empresa->id) }}">
                        @else
                            <form class="row" method="POST" enctype="multipart/form-data"
                                action="{{ route('user_store_company') }}">
                    @endif
                    @csrf
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="razao_social"
                                value="{{ $count_empresa ? $empresa->razao_social : '' }}" id="account-fn"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cnpj"
                                value="{{ $count_empresa ? $empresa->cnpj : '' }}" id="account-ln"
                                placeholder="00.000.000/0000-00" onkeyup="mascara('##.###.###/####-##',this,event,true)"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="account-ln" placeholder="Nome Fantasia"
                                name="nome_fantasia" value="{{ $count_empresa ? $empresa->nome_fantasia : '' }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="password" name="password"
                                value="{{ $count_empresa ? ($empresa->password ? decrypt($empresa->password) : '') : '' }}"
                                id="password">
                        </div>
                                                ...
                                                <div class="custom-control custom-checkbox custom-control-inline">
                                                    @if ($count_empresa)
                                                        <input class="custom-control-input" type="checkbox"
                                                            ...
                                                            value="{{ $category->id }}"
                                                            {{ in_array($category->id, $empresa_categories) ? 'checked' : '' }}>
                                                    @else
                                                        <input class="custom-control-input" type="checkbox"
                                                            id="category_{{ $category->id }}" name="category[]"
                                                            value="{{ $category->id }}">
                                                    ...
                                                    <label class="custom-control-label"
                                                        for="category_{{ $category->id }}">{{ Str::upper($category->nome) }}</label>
                                                </div>
                                            </td>
                                            @if ($i % 5 == 0)
                                    </tr>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="telefone"
                                value="{{ $count_empresa ? $empresa->telefone : '' }}" id="account-phone"
                                placeholder="(91)99999-9999" required onkeyup="mascara('(##) #####-####',this,event,true)"
                                maxlength="15">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cep"
                                value="{{ $count_empresa ? $empresa->cep : '' }}" id="cep" placeholder="00000000"
                                onkeyup="mascara('########',this,event,true)" maxlength="8" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="endereco"
                                value="{{ $count_empresa ? $empresa->endereco : '' }}" id="endereco"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="complemento"
                                value="{{ $count_empresa ? $empresa->complemento : '' }}" id="complemento"
                                placeholder="Complemento para o endereço">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="numero_endereco"
                                value="{{ $count_empresa ? $empresa->numero_endereco : '' }}" id="account-ln"
                                placeholder="Endereço completo" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="perimetro"
                                value="{{ $count_empresa ? $empresa->perimetro : '' }}" id="account-ln"
                                placeholder="Perímetro da localização da empresa">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="bairro" id="bairro"
                                value="{{ $count_empresa ? $empresa->bairro : '' }}" placeholder="Endereço completo"
                                required>
                        </div>
                    </div>
                    <div class="col-md-6">
    ...
    @endforeach -->
                            ...
                            @endphp
                            <input class="form-control" type="text" name="uf" value="{{ $ufValue }}"
                                id="uf" placeholder="UF" required readonly>
...
@else
    -->
                            ...
                            <input class="form-control" type="text" name="cidade"
                                value="{{ $count_empresa ? $empresa->nome_cidade : '' }}" id="cidade"
                                placeholder="Localidade" required readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="facebook"
                                value="{{ $count_empresa ? $empresa->facebook : '' }}" placeholder="Facebook">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="instagram"
                                value="{{ $count_empresa ? $empresa->instagram : '' }}" placeholder="Instagram">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="youtube" id="youtube"
                                value="{{ $count_empresa ? $empresa->youtube : '' }}" placeholder="Youtube">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tiktok" id="tiktok"
                                value="{{ $count_empresa ? $empresa->tiktok : '' }}" placeholder="Tiktok">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input class="custom-control-input" type="radio" id="empresa_parceira"
                                    name="id_categoria_empresas" value="1"
                                    {{ $count_empresa ? ($empresa->id_categoria_empresas == 2 ? '' : 'checked') : '' }}>
                                <label class="custom-control-label" for="empresa_parceira">PARCEIRA</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input class="custom-control-input" type="radio" id="empresa_conveniada"
                                    name="id_categoria_empresas" value="2"
                                    {{ $count_empresa ? ($empresa->id_categoria_empresas == 2 ? 'checked' : '') : '' }}>
                                <label class="custom-control-label" for="empresa_conveniada">COVÊNIADA</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6" id="div_desconto"
                        @if ($count_empresa) @if ($empresa->id_categoria_empresas == 2) style="display: none" @endif
                        @endif>
                        <div class="form-group">
                            <label for="desconto">PORCENTAGEM DE DESCONTO OFERECIDO</label>
                            <input class="form-control" type="number" name="desconto" id="desconto"
                                value="{{ $count_empresa ? $empresa->desconto : '5' }}" placeholder="%" min="5">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="time" name="hora_abertura" id="hora_abertura"
                                value="{{ $count_empresa ? $empresa->hora_abertura : '' }}" placeholder="00:00" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="hora_fechamento">HORÁRIO DE FECHAMENTO</label>
                            <input class="form-control" type="time" name="hora_fechamento" id="hora_fechamento"
                                value="{{ $count_empresa ? $empresa->hora_fechamento : '' }}" placeholder="00:00"
                                required>
                        </div>
                    </div>
                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="gallery-item">
                                        <img id="img-logo-empresa" class="d-block mx-auto img-thumbnail mb-6"
                                            src="{{ asset($empresa->capa()) }}" alt="Logo"
