...
@section('content')
 ...
 <div class="offcanvas-wrapper">
    ...
    <div class="page-title">
		<div class="container">
			<div class="column">
				<h1>Dúvidas Frequentes - Parceiro</h1>
			</div>
			<div class="column">
				...
				<div class="accordion" id="accordion" role="tablist">
					<div class="card">
						<div class="card-header" role="tab">
							<h6><a class="collapsed" href="#collapse1" data-toggle="collapse">Por que ser um parceiro Multben?</a></h6>
						</div>
						<div class="collapse" id="collapse1" data-parent="#accordion" role="tabpanel">
							<div class="card-body">
								<p>Como o próprio nome da plataforma já declara, ser um parceiro Multben promove á empresa que se associa, inúmeros benefícios:</p>
					...
					<div class="card">
						<div class="card-header" role="tab">
							<h6><a class="collapsed" href="#collapse2" data-toggle="collapse">Como se tornar um parceiro Multben?</a></h6>
						</div>
						<div class="collapse" id="collapse2" data-parent="#accordion" role="tabpanel">
							<div class="card-body">
								<p>Clique em SEJA PARCEIRO e preencha os dados na área de cadastro. Após ter salvo as informações, você será direcionado para preenchimento de dados complementares.</p>
							</div>
						</div>
					</div>
					<div class="card">
						<div class="card-header" role="tab">
							<h6><a class="collapsed" href="#collapse3" data-toggle="collapse">Desconto de Parceiros</a></h6>
						</div>
						<div class="collapse" id="collapse3" data-parent="#accordion" role="tabpanel">
							<div class="card-body">
								<p>Na conclusão do cadastramento, você precisa informar quanto de desconto concederá aos assinantes MULTBEN. É possível alterar o percentual de desconto a qualquer tempo, lembrando sempre de salvar essa informação na área de alteração.</p>
							</div>
						</div>
					</div>
					<div class="card">
						<div class="card-header" role="tab">
							<h6><a class="collapsed" href="#collapse4" data-toggle="collapse">Atendimento de assinante Multben</a></h6>
						</div>
						<div class="collapse" id="collapse4" data-parent="#accordion" role="tabpanel">
							<div class="card-body">
								<p>O usuário deve informar que é um assinante MUltben. seu código ID e apresentar seu documento de identidade no início do atendimento. O parceiro checará se esse cadastro está ativo e concederá o desconto pré-estabelecido pelo parceiro na plataforma.</p>
							</div>
						</div>
					</div>
					<div class="card">
						<div class="card-header" role="tab">
							<h6><a class="collapsed" href="#collapse5" data-toggle="collapse">O parceiro tem algum tipo de custo?</a></h6>
						</div>
					...
					<div class="card">
						<div class="card-header" role="tab">
							<h6><a class="collapsed" href="#collapse6" data-toggle="collapse">O que é Multben?</a></h6>
						</div>
						<div class="collapse" id="collapse6" data-parent="#accordion" role="tabpanel">
							<div class="card-body">
								<p>Quando o assinante indica amigos para a MULTBEN e esses amigos se ativam, ele ganha bônus que são transformados em dinheiro, para usar em qualquer serviço da rede credenciada.</p>
								<p>Todas as ativações mensais geram bônus de forma recorrente.</p>
							</div>
						</div>
					</div>
					<div class="card">
						<div class="card-header" role="tab">
							<h6><a class="collapsed" href="#collapse7" data-toggle="collapse">Recebimento de Multben</a></h6>
						</div>
						<div class="collapse" id="collapse7" data-parent="#accordion" role="tabpanel">
							<div class="card-body">
								<p>O assinante solicita á MULTBEN que deseja utilizar um valor específico de seu MULTônus e indica o parceiro credenciado. Neste momento a MULTBEN efetua o repasse do valor antecipado para o parceiro e envia o comprovante de transferência no prazo de 72h e libera um voucher eletrônico.</p>
							</div>
						</div>
					</div>
					<div class="card">
						<div class="card-header" role="tab">
							<h6><a class="collapsed" href="#collapse8" data-toggle="collapse">Como funciona a utilização de Multben?</a></h6>
						</div>
						<div class="collapse" id="collapse8" data-parent="#accordion" role="tabpanel">
							<div class="card-body">
								<p>O assinante informa ao parceiro no momento do atendimento que tem um voucher de bônus e apresenta o documento de identificação pessoal com foto. O parceiro que fará o atendimento, deve confirmar o voucher eletrônico na área específica dentro da plataforma, bem como se os documentos de identificação estão de acordo.</p>
							</div>
						</div>
					</div>
					<!--
					...
					<div class="card">
						...
						<div class="collapse" id="collapse12" data-parent="#accordion" role="tabpanel">
							<div class="card-body">Não. Você pode usar os serviços em todos os parceiros cadastrados de forma ilimitada com o benefício de descontos exclusivos.</div>
						</div>
					</div>
					<div class="card">
						<div class="card-header" role="tab">
					...
					<div class="card">
						<div class="card-header" role="tab">
							<h6><a class="collapsed" href="#collapse20" data-toggle="collapse">texto</a></h6>
						</div>
						<div class="collapse" id="collapse20" data-parent="#accordion" role="tabpanel">
